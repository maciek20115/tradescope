...
const AnalysisDisplay: React.FC<AnalysisDisplayProps> = ({ result }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-8 p-6 bg-slate-800/50 border border-slate-700 rounded-2xl shadow-2xl shadow-black/30 backdrop-blur-sm animate-fade-in">
